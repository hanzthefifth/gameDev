...
namespace Game.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        protected override void Start()
        {
            ...
            {
                // Infinite ammo or no-mag weapon: start at some sensible value.
                ammunitionCurrent = int.MaxValue; // or 0, depending on your design
        ...
        {
            // Infinite ammo weapon: treat total as a large number (or 0 if you prefer).
            if (magazineBehaviour == null)
                return int.MaxValue; // or return 0;
